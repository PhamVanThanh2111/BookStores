...
//		pnCenN.setBorder(new TitledBorder(null, "Thông Tin: ", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 126, 197)));
		pnCenN.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(0,126,197)), "Thông Tin:", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 126, 197)));
		...
		pnCenS.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(0,126,197)), "Chức Năng:", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 126, 197)));
		mMain.add(pnCenS);
