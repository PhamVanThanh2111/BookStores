...
public class PhatSinhMa_DAO {
	...
	public String getMaCuaHang() throws SQLException {
		...
		ResultSet resultSet = statement.executeQuery(
				"select CONCAT('CH', RIGHT(CONCAT('000',ISNULL(right(max(maCH),3),0) + 1),3)) from [dbo].[CuaHang] where maCH like 'CH%'");
		String maCH = "";
	...
	public String getMaNhanVien() throws SQLException {
		...
		Statement statement = con.createStatement();
		ResultSet resultSet = statement.executeQuery(
				"select CONCAT('NV', RIGHT(CONCAT('000',ISNULL(right(max(maNV),3),0) + 1),3)) from [dbo].[NhanVien] where maNV like 'NV%'");
		String maNV = "";
		while (resultSet.next()) {
	...
	public String getMaHoaDon() throws SQLException {
		...
		Statement statement = con.createStatement();
		ResultSet resultSet = statement.executeQuery(
				"select CONCAT('HD', RIGHT(CONCAT('000',ISNULL(right(max(maHD),3),0) + 1),3)) from [dbo].[HoaDon] where maHD like 'HD%'");
		String maHD = "";
		while (resultSet.next()) {
	...
	public String getMaLoaiSach() throws SQLException {
		...
		Statement statement = con.createStatement();
		ResultSet resultSet = statement.executeQuery(
				"select CONCAT('LS', RIGHT(CONCAT('000',ISNULL(right(max(maLS),3),0) + 1),3)) from [dbo].[LoaiSach] where maLS like 'LS%'");
		String maLS = "";
		while (resultSet.next()) {
	...
	public String getMaSach() throws SQLException {
		...
		Statement statement = con.createStatement();
		ResultSet resultSet = statement.executeQuery(
				"select CONCAT('S', RIGHT(CONCAT('000',ISNULL(right(max(maSach),3),0) + 1),3)) from [dbo].[Sach] where maSach like 'S%'");
		String maSach = "";
		while (resultSet.next()) {
	...
	public String getMaNhaXuatBan() throws SQLException {
		...
		Statement statement = con.createStatement();
		ResultSet resultSet = statement.executeQuery(
				"select CONCAT('NXB', RIGHT(CONCAT('000',ISNULL(right(max(maNXB),3),0) + 1),3)) from [dbo].[NXB] where maNXB like 'NXB%'");
		String maNXB = "";
		while (resultSet.next()) {
	...
	public String getMaTaiKhoan() throws SQLException {
		...
		Statement statement = con.createStatement();
		ResultSet resultSet = statement.executeQuery(
				"select CONCAT('NV', RIGHT(CONCAT('000',ISNULL(right(max(taiKhoan),3),0) + 1),3)) from [dbo].[TaiKhoan] where taiKhoan like 'NV%'");
		String maTaiKhoan = "";
		while (resultSet.next()) {
