...
public class DatHang_GUI extends JPanel {
	...
	public DatHang_GUI(NhanVien nhanVien) {
		...
		JButton btnDatHang = new JButton("Lập HD");
		btnDatHang.setIcon(new ImageIcon(HoaDon_GUI.class.getResource("/image/HeThong/wallet.png")));
